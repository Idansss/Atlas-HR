...
7. Close with respect: "I know this is difficult news. We will give you space, and HR will stay available for follow-up questions."
</Steps>
...
<FAQ items={[
  { q: "Should HR or the manager deliver the termination message?", a: "The manager should usually deliver the decision because they own the employment relationship. HR should attend to support process, documentation, and employee questions." },
  { q: "Can we terminate without a PIP?", a: "Sometimes, especially for serious conduct or roles where performance expectations were already clear. For ordinary performance issues, a documented improvement process is usually safer and fairer." },
  { q: "Should the employee work their notice period?", a: "It depends on role risk, contract terms, local law, and business continuity. Some employees work notice; others receive pay in lieu if allowed." },
  { q: "What makes a termination high risk?", a: "Recent protected leave, pregnancy, disability, whistleblowing, harassment complaints, union activity, pay complaints, inconsistent treatment, weak documentation, or a manager with a history of conflict." }
]} />
